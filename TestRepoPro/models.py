...
class SecurityTestExecInfo( models.Model ):
...
class SecurityOpenPortServices( models.Model ):
    ops_id = models.AutoField( primary_key=True )
    st_id = models.ForeignKey( SecurityTestExecInfo, db_column='st_id' )
...
class SecurityVulInfo( models.Model ):
    vul_id = models.AutoField( primary_key=True )
    st_id = models.ForeignKey( SecurityTestExecInfo, db_column='st_id' )
